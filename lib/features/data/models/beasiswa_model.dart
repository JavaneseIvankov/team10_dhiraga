...
class BeasiswaModel extends BeasiswaEntity {
  ...
  BeasiswaModel({
    ...
    super.universitas = const ["Tidak dibatasi"],
    required super.manfaat,
    required super.syarat,
    required super.lampiran,
    required super.pembiayaan,
    super.minimalIPK = 0,
    super.semester = const [1, 2, 3, 4, 5, 6, 7, 8],
    super.jumlahBookmark = 0,
    required super.nama,
  }) : super() {
  ...
  factory BeasiswaModel.fromJson(Map<String, dynamic> json) {
    return BeasiswaModel(
      ...
      universitas: List<String>.from(json['universitas'] ?? ["Tidak dibatasi"]),
